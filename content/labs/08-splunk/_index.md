...
I'll add a small security operations center to help investigate security events using the `juicero` server logs and a security information and event management (SIEM) tool called [Splunk](https://www.splunk.com/).
